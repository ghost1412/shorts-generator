      ...
      if (user) {
        ...
        if (data) {
          setConfig(prev => ({
            ...
            pinterest_access_token: data.pinterest_access_token || '',
      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <section className="glass-card p-8 space-y-6">
            <div className="flex justify-between items-start">
              <div className="flex items-center gap-3">
                <div className="p-3 bg-white/5 rounded-2xl border border-white/5 text-rose-500">
                ...
                <div>
                  <h3 className="font-bold">Pinterest Monetization</h3>
                  <p className="text-xs text-zinc-500 uppercase tracking-widest font-semibold">Affiliate Traffic</p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                <label className="text-xs font-medium text-zinc-400">Pinterest Access Token</label>
                <input 
                  type="password"
                  ...
                  className="w-full bg-white/5 border border-white/10 rounded-xl p-3 text-xs focus:border-[#e60023]/50 outline-none transition-all"
                />
              </div>
              <div className="space-y-2">
                <label className="text-xs font-medium text-zinc-400">Target Board ID</label>
                <input 
                  type="text"
                  value={config.pinterest_board_id}
                  onChange={(e) => setConfig({ ...config, pinterest_board_id: e.target.value })}
            ...
            <div className="p-4 bg-rose-500/10 border border-rose-500/20 rounded-xl">
              <p className="text-[10px] text-rose-300 leading-relaxed italic">
                💡 Tip: Use your Access Token to enable automated Pin creation. Traffic from Pinterest can be redirected to affiliate links for passive income.
              </p>
            </div>
          </section>
